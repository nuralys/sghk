...
class PagesController extends AppController {
	...
	public $uses = array('Page', 'News', 'Honor', 'Client', 'Certification');
	...
	public function index(){
		...
		$honors = $this->Honor->find('all', array(
			'limit' => 12
			));
		...
		$this->set(compact('page', 'title_for_layout', 'meta', 'news', 'honors','clients', 'certifications'));
	}
